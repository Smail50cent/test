...
<div id="footer_id" class="footer footer_structure footer_personalize">
    <input type="button"  class="btn_recapitulatif_commande btn_recapitulatif_commande_structure btn_recapitulatif_commande_personalize btn_recapitulatif_commande_carte btn_recapitulatif_commande_carte_structure btn_recapitulatif_commande_carte_personalize" id="btn_recapitulatif_commande_id" onclick="recapitulatifClick();" value="Recapitulatif de votre commande"/>
